        ...
        <div className="flex relative min-h-full items-center flex-1 flex-col justify-start px-6 lg:px-8">
            ...
            <ModalWithBackdrop show={Boolean(showModal)} onClose={() => {
                ...
                <div className="flex flex-col space-y-4">
                    ...
                    />
                    <Button onClick={spaces.find((space) => space.id === showModal)?.occuped ? markNotOccuped : markAsOccuped}>
                        {spaces.find((space) => space.id === showModal)?.occuped ? "Ocupar" : "Desocupar"}</Button>
                </div>
            </ModalWithBackdrop>
